...
typedef enum{ IDLE, WALK, WALK_BACK, JUMP, JUMP_BACK, ATTACK, DASH, GET_ATTACKED, BLOCK, PARRY, FALL, CROUCH}PLAYER_STATE;
...
typedef enum{NONE, QUARTER_CIRCLE_RIGHT}SPECIAL_INPUT;
